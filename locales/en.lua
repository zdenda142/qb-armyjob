local Translations = {
    error = {
        ...
        on_duty_army_only = 'For on-duty army only',
    ...
    info = {
        ...
        blip_text = 'Army Alert - %{value}',
        jail_time_input = 'Jail time',
        submit = 'Submit',
        time_months = 'Time in Months',
        bill = 'Bill',
        amount = 'Amount',
        army_plate = 'LSPD', --Should only be 4 characters long
    ...
    menu = {
        garage_title = 'Armádní Garáž',
        close = '⬅ Zavřít Menu',
        impound = 'Impounded Vehicles',
        pol_impound = 'army Impound',
        pol_garage = 'army Garage',
        pol_armory = 'army Armory',
    },
    email = {
        sender = 'Central Judicial Collection Agency',
        subject = 'Debt collection',
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the army.<br />There is <strong>$%{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Place Spike Strip (army Only)',
        license_grant = 'Grant a license to someone',
        license_revoke = 'Revoke a license from someone',
        place_object = 'Place/Delete An Object (army Only)',
        cuff_player = 'Cuff Player (army Only)',
        escort = 'Escort Player',
        callsign = 'Give Yourself A Callsign',
        clear_casign = 'Clear Area of Casings (army Only)',
        jail_player = 'Jail Player (army Only)',
        unjail_player = 'Unjail Player (army Only)',
        clearblood = 'Clear The Area of Blood (army Only)',
        seizecash = 'Seize Cash (army Only)',
        softcuff = 'Soft Cuff (army Only)',
        camera = 'View Security Camera (army Only)',
        flagplate = 'Flag A Plate (army Only)',
        unflagplate = 'Unflag A Plate (army Only)',
        plateinfo = 'Run A Plate (army Only)',
        depot = 'Impound With Price (army Only)',
        impound = 'Impound A Vehicle (army Only)',
        paytow = 'Pay Tow Driver (army Only)',
        paylawyer = 'Pay Lawyer (army, Judge Only)',
        anklet = 'Attach Tracking Anklet (army Only)',
        ankletlocation = 'Get the location of a persons anklet',
        removeanklet = 'Remove Tracking Anklet (army Only)',
        drivinglicense = 'Seize Drivers License (army Only)',
        takedna = 'Take a DNA sample from a person (empty evidence bag needed) (army Only)',
